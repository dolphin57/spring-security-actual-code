 ...
 * @Description:
 * @Author: dolphin
 * @Since: 2021-5-15 12:23
 */
public class DolphinJdbcConnectionRepository implements ConnectionRepository {
    ...
    public DolphinJdbcConnectionRepository(String userId, JdbcTemplate jdbcTemplate, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor, String tablePrefix) {
        this.userId = userId;
