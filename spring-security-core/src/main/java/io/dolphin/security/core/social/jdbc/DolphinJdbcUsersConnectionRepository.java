package io.dolphin.security.core.social.jdbc;
 ...
 * @Description:
 * @Author: dolphin
 * @Since: 2021-5-15 12:26
 */
public class DolphinJdbcUsersConnectionRepository implements UsersConnectionRepository {
    ...
    public DolphinJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new DolphinJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
    }
