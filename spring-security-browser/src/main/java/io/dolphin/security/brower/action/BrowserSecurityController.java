package io.dolphin.security.brower.action;
    ...
    public ResultVO requireAuthentication(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (savedRequest != null) {
            ...
            if (StringUtils.endsWithIgnoreCase(targetUrl, ".html")) {
                redirectStrategy.sendRedirect(request, response, dolphinSecurityProperties.getBrowser().getLoginPage());
            }
        }
        //如果有引发跳转的请求且不以html结尾
