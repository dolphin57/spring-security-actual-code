...
public class TokenStoreConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "dolphin.security.oauth2", name = "tokenStore", havingValue = "redis")
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "dolphin.security.oauth2", name = "tokenStore", havingValue = "jwt", matchIfMissing = true)
    public static class JwtConfig {
        ...
        public TokenEnhancer jwtTokenEnhancer() {
            return new DolphinJwtTokenEnhancer();
        }
    }
}
